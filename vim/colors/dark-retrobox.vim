...
"
" A dark twist on the retro groove color scheme similar to gruvbox originally
" designed by morhetz <morhetz@gmail.com>,
" based on work by Maxim Kim <habamax@gmail.com>,
" ported from gruvbox8 of Lifepillar <lifepillar@lifepillar.me>

hi clear
let g:colors_name = 'dark-retrobox'
...
if &background == 'dark'
  let g:terminal_ansi_colors = ['#000000', '#cc241d', '#87d7d7', '#d79921', '#87d7d7', '#b16286', '#689d6a', '#a89984', '#928374', '#fb5944', '#87d7d7', '#fabd2f', '#83a598', '#d3869b', '#8ec07c', '#ebdbb2']

  hi Normal guifg=#ebdbb2 guibg=#000000 guisp=NONE gui=NONE ctermfg=187 ctermbg=234 cterm=NONE term=NONE
  ...
  hi ColorColumn guifg=NONE guibg=#1c1c1c guisp=NONE gui=NONE ctermfg=NONE ctermbg=16 cterm=NONE term=reverse
  hi Comment guifg=#928374 guibg=NONE guisp=NONE gui=NONE ctermfg=102 ctermbg=NONE cterm=NONE term=bold
  hi Conceal guifg=#000000 guibg=NONE guisp=NONE gui=NONE ctermfg=239 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi Cursor guifg=#000000 guibg=#fbf1c7 guisp=NONE gui=NONE ctermfg=234 ctermbg=230 cterm=NONE term=reverse
  hi CursorIM guifg=#000000 guibg=#fbf1c7 guisp=NONE gui=NONE ctermfg=234 ctermbg=230 cterm=NONE term=NONE
  hi CursorLine guifg=NONE guibg=#303030 guisp=NONE gui=NONE ctermfg=NONE ctermbg=236 cterm=NONE term=underline
  hi CursorLineNr guifg=#fabd2f guibg=#000000 guisp=NONE gui=bold ctermfg=214 ctermbg=234 cterm=bold term=bold
  ...
  hi Delimiter guifg=#87d7d7 guibg=NONE guisp=NONE gui=NONE ctermfg=208 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi Directory guifg=#87d7d7 guibg=NONE guisp=NONE gui=bold ctermfg=142 ctermbg=NONE cterm=bold term=NONE
  hi EndOfBuffer guifg=#000000 guibg=NONE guisp=NONE gui=NONE ctermfg=239 ctermbg=NONE cterm=NONE term=NONE
  hi Error guifg=#fb5944 guibg=#000000 guisp=NONE gui=bold,reverse ctermfg=203 ctermbg=234 cterm=bold,reverse term=bold,reverse
  hi ErrorMsg guifg=#000000 guibg=#fb5944 guisp=NONE gui=bold ctermfg=234 ctermbg=203 cterm=bold term=bold,reverse
  ...
  hi FoldColumn guifg=#928374 guibg=#000000 guisp=NONE gui=NONE ctermfg=102 ctermbg=234 cterm=NONE term=NONE
  hi Folded guifg=#928374 guibg=#121212 guisp=NONE gui=NONE ctermfg=102 ctermbg=233 cterm=NONE term=NONE
  hi Function guifg=#87d7d7 guibg=NONE guisp=NONE gui=bold ctermfg=142 ctermbg=NONE cterm=bold term=NONE
  ...
  hi MatchParen guifg=NONE guibg=#000000 guisp=NONE gui=bold,underline ctermfg=NONE ctermbg=239 cterm=bold,underline term=bold,underline
  ...
  hi NonText guifg=#928374 guibg=NONE guisp=NONE gui=NONE ctermfg=239 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi PmenuExtraSel guifg=#a89984 guibg=#000000 guisp=NONE gui=NONE ctermfg=102 ctermbg=239 cterm=NONE term=NONE
  hi PmenuKind guifg=#fb5944 guibg=#3c3836 guisp=NONE gui=NONE ctermfg=203 ctermbg=237 cterm=NONE term=NONE
  hi PmenuKindSel guifg=#fb5944 guibg=#000000 guisp=NONE gui=NONE ctermfg=203 ctermbg=239 cterm=NONE term=NONE
  hi PmenuMatch guifg=#d3869b guibg=#3c3836 guisp=NONE gui=NONE ctermfg=175 ctermbg=237 cterm=NONE term=NONE
  hi PmenuMatchSel guifg=#d3869b guibg=#000000 guisp=NONE gui=NONE ctermfg=175 ctermbg=239 cterm=NONE term=NONE
  hi PmenuSbar guifg=NONE guibg=#3c3836 guisp=NONE gui=NONE ctermfg=NONE ctermbg=237 cterm=NONE term=reverse
  hi PmenuSel guifg=NONE guibg=#000000 guisp=NONE gui=NONE ctermfg=NONE ctermbg=239 cterm=NONE term=bold
  ...
  hi Question guifg=#87d7d7 guibg=NONE guisp=NONE gui=bold ctermfg=208 ctermbg=NONE cterm=bold term=standout
  ...
  hi SignColumn guifg=#928374 guibg=#000000 guisp=NONE gui=NONE ctermfg=102 ctermbg=234 cterm=NONE term=reverse
  hi Special guifg=#87d7d7 guibg=NONE guisp=NONE gui=NONE ctermfg=208 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi SpecialKey guifg=#fb5944 guibg=NONE guisp=NONE gui=NONE ctermfg=102 ctermbg=NONE cterm=NONE term=bold
  ...
  hi StatusLine guifg=#000000 guibg=#ebdbb2 guisp=NONE gui=reverse ctermfg=239 ctermbg=187 cterm=reverse term=reverse
  hi StatusLineNC guifg=#3c3836 guibg=#a89984 guisp=NONE gui=reverse ctermfg=237 ctermbg=102 cterm=reverse term=underline
  hi StorageClass guifg=#87d7d7 guibg=NONE guisp=NONE gui=NONE ctermfg=208 ctermbg=NONE cterm=NONE term=NONE
  hi String guifg=#87d7d7 guibg=NONE guisp=NONE gui=NONE ctermfg=142 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi TabLineSel guifg=#fbf1c7 guibg=#000000 guisp=NONE gui=bold ctermfg=230 ctermbg=234 cterm=bold term=bold,reverse
  hi Title guifg=#87d7d7 guibg=NONE guisp=NONE gui=bold ctermfg=142 ctermbg=NONE cterm=bold term=NONE
  ...
  hi Todo guifg=fg guibg=#000000 guisp=NONE gui=bold ctermfg=fg ctermbg=234 cterm=bold term=bold,reverse
  ...
  hi VertSplit guifg=#303030 guibg=#000000 guisp=NONE gui=NONE ctermfg=236 ctermbg=234 cterm=NONE term=NONE
  ...
  hi WildMenu guifg=#83a598 guibg=#000000 guisp=NONE gui=bold ctermfg=109 ctermbg=239 cterm=bold term=bold
...
if &background == 'light'
  let g:terminal_ansi_colors = ['#3c3836', '#cc241d', '#87d7d7', '#d79921', '#87d7d7', '#b16286', '#689d6a', '#7c6f64', '#928374', '#9d0006', '#79740e', '#b57614', '#87d7d7', '#8f3f71', '#427b58', '#fbf1c7']
  ...
  hi Identifier guifg=#87d7d7 guibg=NONE guisp=NONE gui=NONE ctermfg=23 ctermbg=NONE cterm=NONE term=NONE
  hi Ignore guifg=fg guibg=NONE guisp=NONE gui=NONE ctermfg=fg ctermbg=NONE cterm=NONE term=NONE
  ...
  hi SpellCap guifg=#87d7d7 guibg=NONE guisp=#87d7d7 gui=undercurl ctermfg=23 ctermbg=NONE cterm=underline term=underline
  ...
  hi Underlined guifg=#87d7d7 guibg=NONE guisp=NONE gui=underline ctermfg=23 ctermbg=NONE cterm=underline term=underline
  ...
  hi WildMenu guifg=#87d7d7 guibg=#e5d4b1 guisp=NONE gui=bold ctermfg=23 ctermbg=187 cterm=bold term=bold
